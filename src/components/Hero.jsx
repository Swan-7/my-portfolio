  ...
  return (
    ...
    >
      <div className="flex-1 flex items-center justify-center h-full md:p-0 px-8">
        <img src={hero} alt="" className="md:w-2/3 h-full object-cover bg-white rounded-[4rem] " />
      </div>
      <div className="flex-1">
        <div className="md:text-left text-center">
          <h1 className="md:text-[2.8rem] text-2xl md:leading-normal leading-10 text-white font-bold">
